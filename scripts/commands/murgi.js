...
a("চুদা লো");
setTimeout(() => {a({body: "খাংকির ছেলে মেয়ে তর মারে চুদি 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির ছেলে মেয়ে তর কচি বোন রে চুদি 😍.." + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "নাট বল্টু মাগির ছেলে 🤟" + " " + name, mentions: arraytag})}, 66000);
...
setTimeout(() => {a({body: "Hi রিহান এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi রিহান এর জারজ ছেলে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "Welcome রিহান এর পোলা 🥰।" + " " + name, mentions: arraytag})}, 3000);
